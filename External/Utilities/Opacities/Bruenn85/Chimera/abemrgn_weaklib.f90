SUBROUTINE abemrgn_weaklib( n, e_in, rho, t, xneut, xprot, xh, ah, zh, cmpn, cmpp, &
...
USE physcnst_module, ONLY: kmev, dmnp

USE prb_cntl_module, ONLY: iaence
...
REAL(double), DIMENSION(nez), INTENT(out) :: absor ! inverse mean free path for absorption
REAL(double), DIMENSION(nez), INTENT(out) :: emit  ! inverse mean free path for emission 
...
!-----------------------------------------------------------------------
  ...
  CALL abem_cal_weaklib( n, e_in, rho, t, xneut, xprot, xh, ah, zh, cmpn, cmpp, &
...
!-----------------------------------------------------------------------
  ...
  CALL abemnc_weaklib( n, nez, e_in, rho, t, xh, ah, zh, cmpn, cmpp,  &
&   cmpe, absrnc, emisnc )
