	...
	DO iRho=1,nRho
		DO iTemp=1,nTemp
			DO iYp=1,nYp
				...
				ElectronPhotonGasState % t = EOSBaryonTable % TS % States(2) % Values(iTemp)
				ElectronPhotonGasState % rho = EOSBaryonTable % TS % States(1) % Values(iRho)
				ElectronPhotonGasState % ye = EOSBaryonTable % TS % States(3) % Values(iYp)
        ...
        CALL wlGetElectronEOS(ElectronPhotonGasState % rho, &
            ElectronPhotonGasState % t, ElectronPhotonGasState % ye, &
        ...
        entrop_e_BCK = entrop_e_BCK
				...
				press_electrons = ElectronPhotonGasState % pele
