    ...
    DO iRho=1,nRho
        DO iTemp=1,nTemp
            DO iYp=1,nYp
                ...
                Ee(iRho,iTemp,iYp) = ElectronPhotonGasState % e
                Pe(iRho,iTemp,iYp) = ElectronPhotonGasState % p
                
                press_baryons = (EOSBaryonTable % DV % Variables(iPressure) % Values(iRho,iTemp,iYp)) - &
                    EOSBaryonTable % DV % Offsets(iPressure)
                press_electrons = ElectronPhotonGasState % p
                ...
                s_electrons = ElectronPhotonGasState % s * rmu * kmev_inv / ergmev
                ...
                eps_electrons = ElectronPhotonGasState % e
