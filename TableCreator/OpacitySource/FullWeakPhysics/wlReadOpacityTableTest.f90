PROGRAM wlReadOpacityTableTest
  ...
  TestPoint: BLOCK
    ...
    INTEGER  :: iEp, iE, iMoment, iOpacity
    REAL(dp) :: random
    REAL(dp) :: T, MuB
    REAL(dp) :: Interpolant
    ...
    CALL Interpolate_NNS_Point &
           ( T, MuB, iOpacity, iMoment, iEp, iE, Interpolant )
...
CONTAINS
  ...
  SUBROUTINE Interpolate_NNS_Point &
    ...
    INTEGER,  INTENT(in)  :: iOpacity, iMoment, iEp, iE
    ...
    CALL LinearInterp2D_2DArray_Point &
           ( iT, iMuB, dLogT, dMuB, Offset, Table, Interpolant )
  ...
  SUBROUTINE Compute_NNS_Point &
               ( T, MuB, iOpacity, iMoment, Kernel )

    USE wlKindModule, ONLY: &
      dp

    REAL(dp), INTENT(in)  :: T, MuB
    INTEGER,  INTENT(in)  :: iOpacity, iMoment
