SUBROUTINE nc_weak_mag_weaklib( e_nu, xi_p_wm, xi_n_wm, xib_p_wm, xib_n_wm, nez )
!-----------------------------------------------------------------------
!
...
REAL(dp), INTENT(in), DIMENSION(nez)  :: e_nu ! energy grid

!-----------------------------------------------------------------------
!        Output variables.
!-----------------------------------------------------------------------

REAL(dp), INTENT(out), DIMENSION(nez) :: xi_p_wm       ! weak magnetism correction for neutrino-proton scattering
REAL(dp), INTENT(out), DIMENSION(nez) :: xi_n_wm       ! weak magnetism correction for neutrino-neutron scattering
REAL(dp), INTENT(out), DIMENSION(nez) :: xib_p_wm      ! weak magnetism correction for antineutrino-proton scattering
REAL(dp), INTENT(out), DIMENSION(nez) :: xib_n_wm      ! weak magnetism correction for antineutrino-neutron scattering
...
RETURN
END SUBROUTINE nc_weak_mag_weaklib
