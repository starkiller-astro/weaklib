MODULE wlEOSIOModuleHDF
  ...
  ! Uncomment BroadcastMuonTableParallel if you want to use 
  ! The old Tobias stuff
...
CONTAINS
  ...
  ! ------------------------------ CompOSE SECTION ----------------------- !
  ! ---------------------------------------------------------------------- !
  SUBROUTINE WriteEquationOfStateCompOSETableHDF( EOSTable, EOSTableName_Option )
  ...
  END SUBROUTINE WriteEquationOfStateCompOSETableHDF


  SUBROUTINE DescribeEquationOfStateCompOSETable( EOSTable )
  ...
  END SUBROUTINE DescribeEquationOfStateCompOSETable

  SUBROUTINE ReadEquationOfStateComPOSETableHDF( EOSTable, FileName )
    ...
    CALL DescribeEquationOfStateCompOSETable( EOSTable )

    CALL CloseFileHDF( file_id )

  END SUBROUTINE ReadEquationOfStateComPOSETableHDF

  SUBROUTINE BroadcastEquationOfStateCompOSETableParallel &
               ( EOSTable, rootproc, myid, ierr,  COMMUNICATOR )
  ...
  SUBROUTINE TransferCompOSEDependentVariables( OldDV, NewDV, NewLocation, OldLocation )
    ...
    TYPE(DependentVariablesCompOSEType), INTENT(inout)  :: NewDV
    INTEGER, INTENT(in)                          :: OldLocation
    INTEGER, INTENT(in)                          :: NewLocation
  ...
  END SUBROUTINE MatchCompOSETableStructure
