MODULE wlMuonEOS
    ...
    USE wlEosConstantsModule, ONLY: &        
        ergmev, cm3fm3, rmu, mmu
    
    IMPLICIT NONE
    PRIVATE
    
    TYPE, PUBLIC :: MuonGasStateType
...
CONTAINS
    ...
    !$ACC ROUTINE SEQ
        ...
        TYPE (MuonGasStateType), INTENT(INOUT) :: MuonGasState
        ...
        temp  = MuonGasState % t
        ym = MuonGasState % rhoym / MuonGasState % rho
...
!write(*,*) rhoym, MuonTable % rhoym(iT,1), MuonTable % rhoym(iT,iDen_Max)
        ...
        MuonGasState % s = MuonGasState % s * ym
        MuonGasState % e = MuonGasState % e * ym
