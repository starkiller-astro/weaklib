  ...
  SUBROUTINE InvertTemperatureWith_DEYpYl_Guess &
    ...
    DO iL_D=1,2
      DO iL_Y=1,2
        ...
        ElectronPhotonGasState % rho = Ds (iD +iL_D-1)
        ElectronPhotonGasState % ye  = Yps(iYp+iL_Y-1) * Ye_over_Yp

        CALL ElectronPhotonEOS(HelmTable, ElectronPhotonGasState)

        MuonGasState % t     = T_a
        MuonGasState % rho   = Ds(iD+iL_D-1)
        MuonGasState % rhoym = MuonGasState % rho * Yps(iYp+iL_Y-1) * Ym_over_Yp
        
        CALL FullMuonEOS(MuonTable, MuonGasState)
        
        E_LeptPhot = ElectronPhotonGasState % e + MuonGasState % e 
  ...
  SUBROUTINE InvertTemperatureWith_DPYpYl_Guess &
    ...
    DO iL_D=1,2
      DO iL_Y=1,2
        ...
        Xs_a(iL_D,iL_Y) = Xs_a(iL_D,iL_Y) + ElectronPhotonGasState % p + MuonGasState % p
    ...
    DO iL_D=1,2
      DO iL_Y=1,2
        ...
        Xs_b(iL_D,iL_Y) = Xs_b(iL_D,iL_Y) + ElectronPhotonGasState % p + MuonGasState % p
      ...
      DO WHILE ( i_b > i_a + 1 )
        ...
        DO iL_D=1,2
          DO iL_Y=1,2
            ...
            Xs_c(iL_D,iL_Y) = Xs_c(iL_D,iL_Y) + ElectronPhotonGasState % p + MuonGasState % p
      ...
      DO i = 2, SizeTs - 1
        ...
        DO iL_D=1,2
          DO iL_Y=1,2
            ...
            Xs_i(iL_D,iL_Y) = Xs_i(iL_D,iL_Y) + ElectronPhotonGasState % p + MuonGasState % p
  ...
  SUBROUTINE InvertTemperatureWith_DSYpYl_Guess &
    ...
    DO iL_D=1,2
      DO iL_Y=1,2
        ...
        S_LeptPhot = ElectronPhotonGasState % s + MuonGasState % s
