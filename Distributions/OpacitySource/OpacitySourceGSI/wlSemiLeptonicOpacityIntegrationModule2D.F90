...
!=============================================================
  ...
  PUBLIC :: NuCapture2DIntegration
  PUBLIC :: NuBarCapture2DIntegration
  PUBLIC :: InverseNeutronDecay2DIntegration
  PUBLIC :: NeutronEmissivity2DIntegration
...
! --------------------------------------------------------------------------------------------------------------------
! --------------------------------------- INTERFACES FOR THE 4 REACTIONS ---------------------------------------------
! --------------------------------------------------------------------------------------------------------------------
...
SUBROUTINE NuAbsorptionOnNeutrons(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, nE, NodesE2, WeightsE2, NodesE3, WeightsE3, tot)

  REAL(DP), INTENT(IN)  :: Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4
  INTEGER , INTENT(IN)  :: IncludeCorrections(3), nE
  ! Nodes and Weights for Gauss-Legendre integration from 0 to 1 (NOT from -1 to 1) !!!
  ...
  DO iE2=1, nE
    DO iE3=1,nE
      CALL NuCapture2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
        IncludeCorrections, NodesE2(iE2), WeightsE2(iE2), NodesE3(iE3), WeightsE3(iE3), res)
      tot = tot + res
    END DO
  END DO
...
! For a more efficient parallelization this whole thing can be probably taken out, and we make 4 different integrations, one per reaction
SUBROUTINE NuBarAbsorptionOnProtons(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, nE, NodesE2, WeightsE2, NodesE3, WeightsE3, tot)
  ...
  DO iE2=1, nE
    DO iE3=1,nE
      CALL NuBarCapture2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, & 
        IncludeCorrections, NodesE2(iE2), WeightsE2(iE2), NodesE3(iE3), WeightsE3(iE3), res)
      tot = tot + res
    END DO
  END DO
...
SUBROUTINE InverseNeutronDecay(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, nE, NodesE2, WeightsE2, NodesE3, WeightsE3, tot)
  ...
  DO iE2=1, nE
    DO iE3=1,nE
      CALL InverseNeutronDecay2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
        IncludeCorrections, NodesE2(iE2), WeightsE2(iE2), NodesE3(iE3), WeightsE3(iE3), res)
      tot = tot + res
    END DO
  END DO
...
SUBROUTINE NeutronEmissivity(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, nE, NodesE2, WeightsE2, NodesE3, WeightsE3, tot)
  ...
  DO iE2=1, nE
    DO iE3=1,nE
      CALL NeutronEmissivity2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
        IncludeCorrections, NodesE2(iE2), WeightsE2(iE2), NodesE3(iE3), WeightsE3(iE3), res)
      tot = tot + res
    END DO
  END DO
...
! --------------------------------------------------------------------------------------------------------------------
! ------------------------------------ INTEGRATION LOOPS FOR THE 4 REACTIONS -----------------------------------------
! --------------------------------------------------------------------------------------------------------------------

SUBROUTINE NuCapture2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, NodeE2, WeightE2, NodeE3, WeightE3, res)

  REAL(DP), INTENT(IN)  :: Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4
  INTEGER , INTENT(IN)  :: IncludeCorrections(3)
  REAL(DP), INTENT(IN)  :: NodeE2, WeightE2, NodeE3, WeightE3 ! Nodes and Weights for Gauss-Legendre integration from 0 to 1 (NOT from -1 to 1) !!!
  REAL(DP), INTENT(OUT) :: res

  REAL(DP) :: E2, E2_min, E2_max, P2, p2min, p2max, p4max
  REAL(DP) :: E3, E3_min, E3_max, P3, xq0_min, xq0_max
  REAL(DP) :: E4, xf2, xf3, xf4, xamp
  REAL(DP) :: Adjusted_wE2, Adjusted_wE3
  INTEGER  :: iE2, iE3

  res = 0.0d0
  ! This is principle should be outside the 2D energy integral
  ...
  ! This is outside the iE3 loop
  E2 = NodeE2*(E2_max - E2_min) + E2_min
  Adjusted_wE2 = WeightE2*(E2_max - E2_min)
  ...
  ! This is inside the iE3 loop
  E3 = NodeE3*(E3_max - E3_min) + E3_min
  Adjusted_wE3 = WeightE3*(E3_max - E3_min)
  E4 = Enu + E2 - E3
  CALL Calc_ampsq( Enu, T, E2, E3, Mass2, Mass3, Mass4, U2, U4, 1.0d0, 1, IncludeCorrections, xamp)
  xf3 = FD(E3, Mu3, T)
  xf4 = FD(E4, Mu4, T)
  res = xf2*(1.0d0-xf3)*(1.0d0-xf4)*xamp*Adjusted_wE2*Adjusted_wE3 &
      / Enu**2*(Gw_MeV*Vud)**2/16.0d0/(pi**5)/hbarc

END SUBROUTINE NuCapture2DIntegration

SUBROUTINE NuBarCapture2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
  IncludeCorrections, NodeE2, WeightE2, NodeE3, WeightE3, res)
  ...
  Adjusted_wE3 = WeightE3*(E3_max - E3_min)
  E4 = Enu + E2 - E3
  CALL Calc_ampsq( Enu, T, E2, E3, Mass2, Mass3, Mass4, U2, U4, -1.0d0, 2, IncludeCorrections, xamp)
  xf3 = FD(E3, Mu3, T)
  xf4 = FD(E4, Mu4, T)
  res = xf2*(1.0d0-xf3)*(1.0d0-xf4)*xamp*Adjusted_wE2*Adjusted_wE3 &
    /Enu**2*(Gw_MeV*Vud)**2/16.0d0/(pi**5)/hbarc

END SUBROUTINE NuBarCapture2DIntegration

SUBROUTINE InverseNeutronDecay2DIntegration(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
    IncludeCorrections, NodeE2, WeightE2, NodeE3, WeightE3, res)
  ...
  res = 0.0d0
  ! This is principle should be outside the 2D energy integral
  CALL Range_pn_D(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu4, 3, p2min, p2max, p4max)
  IF( p2min > p2max ) RETURN
  E2_min = SQRT(p2min**2 + Mass2**2) + U2
  E2_max = SQRT(p2max**2 + Mass2**2) + U2
  ...
  Adjusted_wE2 = WeightE2*(E2_max - E2_min)
  P2 = SQRT( (E2-U2)**2 - Mass2**2 )
  CALL Ebounds_D( E2, Enu, T, P2, Mass2, Mass3, Mass4, U2, U4, Mu3, p4max, 3, xq0_min, xq0_max )
  E3_min = xq0_min - Enu
  E3_max = xq0_max - Enu
  xf2 = FD(E2, Mu2, T)
  ...
  Adjusted_wE3 = WeightE3*(E3_max - E3_min)
  E4 = Enu + E3 + E2
  CALL Calc_ampsq(Enu, T, E2, -E3, Mass2, Mass3, Mass4, U2, U4, -1.0d0, 3, IncludeCorrections, xamp)
  xf3 = FD(E3, Mu3, T)
  xf4 = FD(E4, Mu4, T)
  res = - xf2*xf3*(1.0d0-xf4)*xamp*Adjusted_wE2*Adjusted_wE3 &
      / Enu**2*(Gw_MeV*Vud)**2/16.0d0/(pi**5)/hbarc

END SUBROUTINE InverseNeutronDecay2DIntegration

SUBROUTINE NeutronEmissivity2DIntegration(Enu, &
    T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu3, Mu4, &
    IncludeCorrections, NodeE2, WeightE2, NodeE3, WeightE3, res)
  ...
  res = 0.0d0
  CALL Range_pn_D(Enu, T, Mass2, Mass3, Mass4, U2, U4, Mu2, Mu4, 4, p2min, p2max, p4max)
  IF( p2min > p2max ) RETURN
  E2_min = SQRT(p2min**2 + Mass2**2) + U2
  E2_max = SQRT(p2max**2 + Mass2**2) + U2
  ...
  Adjusted_wE2 = WeightE2*(E2_max - E2_min)
  P2 = SQRT( (E2-U2)**2 - Mass2**2 )
  CALL Ebounds_D( E2, Enu, T, P2, Mass2, Mass3, Mass4, U2, U4, Mu3, p4max, 4, xq0_min, xq0_max )
  E3_min = xq0_min - Enu
  E3_max = xq0_max - Enu
  xf2 = FD(E2, Mu2, T)
  ...
  Adjusted_wE3 = WeightE3*(E3_max - E3_min)
  E4 = Enu + E3 + E2
  CALL Calc_ampsq(Enu, T, E2, -E3, Mass2, Mass3, Mass4, U2, U4, -1.0d0, 4, IncludeCorrections, xamp)
  xf3 = FD(E3, Mu3, T)
  xf4 = FD(E4, Mu4, T)
  res = - (1.0d0-xf2)*(1.0d0-xf3)*xf4*xamp*Adjusted_wE2*Adjusted_wE3 &
      / Enu**2*(Gw_MeV*Vud)**2/32.0d0/(pi**7)*Enu**2/hbarc**3/hbar

END SUBROUTINE NeutronEmissivity2DIntegration

! --------------------------------------------------------------------------------------------------------------------
! ------------------------------------- ACTUAL PHYSICS BASED ON GSI ROUTINES -----------------------------------------
! --------------------------------------------------------------------------------------------------------------------
...
SUBROUTINE Calc_Ampsq( Enu, T, E2, E3, Mass2, Mass3, Mass4, U2, U4, anti, ReactionIndex, IncludeCorrections, Ampsq )
  ...
  REAL(DP) :: AmassSq,VmassSq,AVmassSq,APmassSq,AFmassSq,VFmassSq,&
       FmassSq,tm3sq,tbet0 
  REAL(DP) :: txi1,Ia2,tgam0,Ib2,txi3,Ic2,Id2,iE3,Ig2,Ih2,Ij2,Ik2,Il2,&
...
!!! adding form-factor dependences
  ...
  IF(IncludeCorrections(3) .eq. 1) THEN
    ...
    iE3 = 4.0d0*( 0.5d0*Iep + 2.0d0*txi1*Ie - 2.0d0*tbet0*Iem )
    ...
    Ampsq_ff0 = cplA2*Ia2 + cplB2*Ib2 + cplC2*Ic2 + cplD2*Id2 + &
        cplE2*iE3 + cplG2*Ig2 + cplH2*Ih2 + cplJ2*Ij2 + cplK2*Ik2 + &
        cplL2*Il2 
  ...
  DO iE2=1,m
    ...
    DO
      ...
      DO iE3=1,n
        p3 = p2
        p2 = p1
        p1 = ((2.d0*iE3 - 1.d0)*z*p2 - (iE3 - 1.d0)*p3)/iE3
      END DO
